...
[data-testid="stAppViewContainer"] {
    background: radial-gradient(circle, #0b0c10 0%, #1d2a3a 100%);
    color: #00ff00;
}
...
@keyframes glitch {
    0%,100% {text-shadow: 0.05em 0 0 #00ff00, -0.05em 0 0 #00ff00;}
    15%     {text-shadow: -0.05em -0.05em 0 #00ff00, 0.05em 0.05em 0 #00ff00;}
}
</style>
"""
